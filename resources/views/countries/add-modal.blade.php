<div class="modal show fade" id="addCountryModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_user_header">
                <h2 class="fw-bolder">{{ __('messages.common.add').' '. __('messages.common.country')}}</h2>
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                    ...
                    <div class="fv-row fv-plugins-icon-container">
                        <div class="mb-5">
                            ...
                            {{ Form::text('short_code', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Short Code']) }}
                        </div>
                    </div>
