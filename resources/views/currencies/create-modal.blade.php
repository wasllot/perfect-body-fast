    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">{{__('messages.currency.add_currency')}}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 mb-6">
                <form id="createCurrencyForm" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    @csrf
                    @method('POST')
                    ...
                    <div class="row gx-10">
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            {{ Form::label('currency_code', __('messages.currency.currency_code').':', ['class' => 'required fw-bold fs-6 mb-2']) }}
