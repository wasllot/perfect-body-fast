<div class="modal show fade" id="createSpecializationModal" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">{{__('messages.specialization.add_specialization')}}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 mb-6">
                ...
                <div class="alert alert-danger d-none" id="createSpecializationValidationErrorsBox"></div>
