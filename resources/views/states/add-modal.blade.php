<div class="modal show fade" id="addStateModal" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_user_header">
                <h2 class="fw-bolder">{{ __('messages.state.add_state') }}</h2>
                ...
                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                    ...
                    <div class="fv-row fv-plugins-icon-container">
                        <div class="mb-5">
                            ...
                            {{ Form::text('name', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Name','required']) }}
                        </div>
                    </div>
                    <div class="fv-row fv-plugins-icon-container">
                        <div class="mb-5">
                            {{ Form::label('country_id', __('messages.state.country').':', ['class' => 'form-label required fs-6 fw-bolder                       text-gray-700 mb-3']) }}
                            {{ Form::select('country_id', $countries, null, ['id' => 'countryState',
                                    'class' => 'form-select form-select-solid','data-dropdown-parent'=>'#addStateModal',
                                    'required','data-control'=>"select2", 'placeholder' => 'Select Country']) }}
                        </div>
                    </div>
                </div>
                <div class="pt-5">
