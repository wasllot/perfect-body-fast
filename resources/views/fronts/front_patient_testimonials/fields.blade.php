<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('designation', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Designation', 'required']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::textarea('short_description', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Short Description', 'required', 'id' => 'shortDescription', 'rows'=> 5, 'maxlength' => '111']) }}
        </div>
    </div>
