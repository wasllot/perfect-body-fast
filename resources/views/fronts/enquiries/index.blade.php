        ...
        <div id="kt_content_container" class="container">
            <div class="card">
                ...
                <div class="card-body pt-0">
                    @include('fronts.enquiries.table')
                    @include('fronts.enquiries.templates.templates')
                </div>
            </div>
        </div>
    </div>
...
@section('page_js')
    <script>
        let all = '{{ \App\Models\Enquiry::ALL }}';
        let read = '{{ \App\Models\Enquiry::READ }}';
        let unread = '{{ \App\Models\Enquiry::UNREAD }}';
    </script>
    <script src="{{ mix('assets/js/custom/custom-datatable.js') }}"></script>
    <script src="{{mix('assets/js/fronts/enquiries/enquiry.js')}}"></script>
@endsection
