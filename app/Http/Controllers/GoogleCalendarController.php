...
//        $this->store($accessToken['access_token']);

        Flash::success('Your Google Calendar is now connected.');
    ...
    public function googleCalendar()
    {
        ...
        $data['checkTimeZone'] = User::whereId(getLogInUserId())->first();
    ...
    public function appointmentGoogleCalendarStore(Request $request)
    {
        ...
        return $this->sendSuccess('Calendar Added Successfully.');
    }
    ...
    public function disconnectGoogleCalendar()
    {
        ...
        Flash::success('Google Calendar disconnected successfully.');
    ...
    public function syncGoogleCalendarList()
    {
        ...
        return $this->sendSuccess('Your Google Calendar updated successfully.');
    }
}
