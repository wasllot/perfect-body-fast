...
(function (root, factory) {
    ...
    var EventEmitter = function () {
        ...
        function getFlush (callbacks, context, args) {
            ...
            function flush () {
                var cancelled;
                for (var i = 0, len = callbacks.length; !cancelled && i <
                len; i += 1) {
            ...
            _getSuggestionsFragment: function getSuggestionsFragment (
                ...
                _.each(suggestions, function getSuggestionNode (suggestion) {
                    ...
                    $el = $(that.templates.suggestion(context)).
                        ...
                        addClass(that.classes.suggestion + ' ' +
    ...
    var Menu = function () {
        ...
        _.mixin(Menu.prototype, EventEmitter, {
            ...
            _onRendered: function onRendered (
                type, dataset, suggestions, async) {
    ...
    var Typeahead = function () {
        ...
        function Typeahead (o, www) {
            var onFocused, onBlurred, onEnterKeyed, onTabKeyed, onEscKeyed,
                onUpKeyed, onDownKeyed, onLeftKeyed, onRightKeyed,
    ...
    (function () {
        ...
        methods = {
            initialize: function initialize (o, datasets) {
                var www;
                datasets = _.isArray(datasets) ? datasets : [].slice.call(
                    arguments, 1);
                o = o || {};
                ...
                function attach () {
                    var $input, $wrapper, $hint, $menu, defaultHint,
                        defaultMenu, eventBus, input, menu, typeahead,
                        MenuConstructor;
        ...
        function revert ($input) {
            ...
            _.each($input.data(keys.attrs), function (val, key) {
                _.isUndefined(val) ? $input.removeAttr(key) : $input.attr(key,
                    val);
            });
