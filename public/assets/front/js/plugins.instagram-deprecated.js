...
window.SEMICOLON_getInstagramPhotos = function (
    element, username, limit, nextkey, images) {

    let newimages = '';

    $.getJSON('https://www.instagram.com/' + username + '/?__a=1' + nextkey,
        function (instagram) {
            ...
            if (!instaPrivate) {
                ...
                if (images.length < limit) {
                    images = SEMICOLON_getInstagramPhotos(element, username,
                        limit, nextkey, images);
                }
